...
public class TourGuideController {
    ...
    public String get5NearbyAttractions(@RequestParam String userName) {
    	VisitedLocation visitedLocation = tourGuideService.getUserLocation(getUser(userName));
    	return JsonStream.serialize(tourGuideService.get5NearByAttractions(visitedLocation));
    }
    ...
    public String getAllCurrentLocations() {
    	...
    	List<User> getAllUsers = tourGuideService.getAllUsers();
    	Map<String,Location> locations = new HashMap<>();
    	for(User user : getAllUsers) {
    		VisitedLocation visitedLocation = tourGuideService.getUserLocation(getUser(user.getUserName()));
